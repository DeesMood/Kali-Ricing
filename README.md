...
**3. Use a GTK theme**
* Download and move "Graphite-teal-Dark-nord (GTK)" to "/usr/share/themes/"
* Apperance > Style > Select "Graphite-teal-Dark-nord (GTK)"


**4. Use monospace font**
* Apperance > Fonts > Select "Monospace Regular"


### Optionals
Didn't do any of these because of course it will consume a bit more resource which I don't want or it just doesn't fit with my current setup.

**5. Change Icon**
* Mine is default from kali "Flat-Remix-Blue-Dark"


**6. Use powerlevel10k or spaceship framework**
* You can add the framework with themes to get a more appealing visual such as icons and more features


**7. Modify your fastfetch to make it pretty**
...
**8. Use a template for your terminal emulator**
